import { Blogify, Focuse, Kalenteri, Boost, C3} from "./img/img";
...
export const projectData: Project[] = [
  {
    ...
    description:
      "A user-friendly calendar view built with React and CSS to showcase student club events at BC. Designed to be visually clear, color-coded by club, and easily filterable by event type or tags. Created as part of a frontend internship project.",
    tech: ["React", "CSS"],
    live: "ei",
    git: "ei",
  },
  ...
  },
  {
    ...
    title: "Blogify",
    description:
      "Express yourself and inspire others with our intuitive blogging app.",
  ...
  },
  {
    ...
    title: "C3",
    description:
      "Here the user can create their own account and add vehicle rentals",
    tech: ["javascript", "Node.js", "Mongodb", "React", "Tailwind CSS"],
    live: "https://cm-3-1bym.onrender.com/",
    git: "https://github.com/Hoopsier/CM-3",
  },
];
