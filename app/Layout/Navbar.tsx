                ...
                <div className="bg-[#4E6688]/20 rounded-full py-2 px-10 text-center">
                    <ul className="flex gap-7 font-bold text-[13px] text-black">
                        <li 
                            ...
                            className="relative text-white hover:cursor-pointer transition-colors duration-200 after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-white after:left-0 after:-bottom-1 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
                        >
                            Experience
                        </li>
                        <li
                            onClick={() => scrollToSection('myprojects')}
                            className="relative text-white cursor-pointer transition-colors duration-200 after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-white after:left-0 after:-bottom-1 after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300"
                        >
                            MyProjects
                        </li>
                    </ul>
                    ...
                    >
                        <ul className="flex flex-col gap-6 text-[#4E6688] text-xl">
                            <li 
                                ...
                                className="relative text-white hover:cursor-pointer transition-colors duration-200 after:content-[''] after:absolute after:w-[100%] after:h-0.5 after:bg-white after:left-0 after:bottom-[-8px] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-left"
                            >
                                Experience
                            </li>
                            <li
                                ...
                                className="relative text-white cursor-pointer transition-colors duration-200 after:content-[''] after:absolute after:w-[100%] after:h-0.5 after:bg-white after:left-0 after:bottom-[-8px] after:scale-x-0 hover:after:scale-x-100 after:transition-transform after:duration-300 after:origin-left"
                            >
                                MyProjects
                            </li>
                        </ul>
